...
pub fn routes() -> Router<AppState> {
    Router::new()
        ...
        .route(
            ...
            post(player_game_profiles::submit_player_rating),
        )
        .route(
            "/{player_id}/games/{game_id}/rating-history",
            get(player_game_profiles::get_player_rating_history),
        )
        .route(
            "/{player_id}/games/{game_id}/mm-stats",
