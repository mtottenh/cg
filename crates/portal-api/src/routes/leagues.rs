...
pub fn routes() -> Router<AppState> {
    Router::new()
        ...
        .route(
            ...
            patch(leagues::update_member_role),
        )
        .route(
            "/{league_id}/members/{user_id}",
            delete(leagues::remove_member),
        )
        ...
        .route(
            "/{league_id}/applications/{application_id}/approve",
            post(leagues::approve_application),
        )
        .route(
            "/{league_id}/applications/{application_id}/reject",
            post(leagues::reject_application),
        )
}
...
pub fn invitation_routes() -> Router<AppState> {
    Router::new()
        ...
        .route(
            ...
            post(leagues::decline_invitation),
        )
}
